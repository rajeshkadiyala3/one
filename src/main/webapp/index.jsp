...
<body>
	...
	<h2 style="color: blue; font-size: 40px;" align="center">WELCOME TO JENKINS </h2>
	<h2 style="color: orange; font-size: 40px;" align="center">THIS IS OUR FIRST DEPLOYMENT</h2>
